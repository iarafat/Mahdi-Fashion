...
const MobileDrawer = () => {
  ...
  return mobile_drawer_jsx(drawer, {
    ...
    src: user_default.a,
    alt: "user_avatar"
  })), mobile_drawer_jsx(header_style["q" /* UserDetails */], null, mobile_drawer_jsx("h3", null, "David Kinderson"), mobile_drawer_jsx("span", null, "+990 374 987"))) : mobile_drawer_jsx(header_style["j" /* LogoutView */], null, mobile_drawer_jsx(button_button["a" /* Button */], {
    variant: "primary",
    onClick: signInOutForm
  }, mobile_drawer_jsx(external_react_intl_["FormattedMessage"], {
    id: "mobileSignInButtonText",
    defaultMessage: "join"
  })))), mobile_drawer_jsx(header_style["c" /* DrawerMenu */], null, site_navigation["l" /* MOBILE_DRAWER_MENU */].map(item => mobile_drawer_jsx(header_style["d" /* DrawerMenuItem */], {
    key: item.id
  ...
  })))), isAuthenticated && mobile_drawer_jsx(header_style["r" /* UserOptionMenu */], null, mobile_drawer_jsx(header_style["d" /* DrawerMenuItem */], null, mobile_drawer_jsx(nav_link["a" /* default */], {
    href: site_navigation["m" /* PROFILE_PAGE */],
    label: "Your Account Settings",
    className: "drawer_menu_item",
    intlId: "navlinkAccountSettings"
  })), mobile_drawer_jsx(header_style["d" /* DrawerMenuItem */], null, mobile_drawer_jsx("div", {
