...
exports.modules = {
  ...
  /***/ KVzP: /***/ function (
    ...
    const CartButton = external_styled_components_default()(
      ...
      Object(theme_get_['themeGet'])('colors.white', '#ffffff'),
      Object(theme_get_['themeGet'])('radii.big', '18px'),
      Object(theme_get_['themeGet'])('fontSizes.sm', '13'),
      Object(theme_get_['themeGet'])('fontWeights.bold', '700'),
      Object(theme_get_['themeGet'])('colors.primary.regular', '#009E7F')
    );
    const Counter = external_styled_components_default()(
      counter['a' /* Counter */]
    ).withConfig({
    ...
    const ProductCard = (_ref) => {
      ...
      return __jsx(
        ...
        __jsx(
          ...
          {
            className:
              isInCart(data === null || data === void 0 ? void 0 : data.id) &&
              'overlay',
          },
          ...
          !isInCart(data === null || data === void 0 ? void 0 : data.id)
            ? __jsx(
                ...
                __jsx(PlusOutline['a' /* PlusOutline */], null)
              )
            : __jsx(Counter, {
                value: getItem(
        ...
        __jsx(
          InfoWrapper,
          null,
          __jsx(Price, null, currency, price),
          __jsx(Title, null, title),
          __jsx(Unit, null, weight)
        )
      );
    };

    /* harmony default export */ var product_card_five = (__webpack_exports__[
      'default'
    ] = ProductCard);
