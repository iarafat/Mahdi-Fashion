...
exports.modules = {
  ...
  /***/ F5TP: /***/ function (
    ...
    const ProductInfoWrapper = external_styled_components_default.a.div.withConfig(
      ...
      Object(theme_get_['themeGet'])('colors.lightMediumColor', '#f3f3f3')
    );
    ...
    const QuickView = ({ modalProps, deviceType, onModalClose }) => {
      ...
      return quick_view_jsx(
        ...
        quick_view_jsx(
          ...
          quick_view_jsx(CloseIcon['a' /* CloseIcon */], null)
        ),
        quick_view_jsx(
          QuickViewWrapper,
          null,
            ...
            quick_view_jsx(
              ...
              quick_view_jsx(
                ...
                quick_view_jsx(
                  ...
                  null,
                  quick_view_jsx(ProductTitle, null, title),
                  quick_view_jsx(
                    ProductPriceWrapper,
                    null,
                    discountInPercent
                ...
                quick_view_jsx(ProductWeight, null, unit),
                quick_view_jsx(
                  ProductDescription,
                  null,
                  quick_view_jsx(
                  ...
                  quick_view_jsx(
                    ...
                    !isInCart(id)
                      ? quick_view_jsx(
                          ...
                          quick_view_jsx(CartIcon['a' /* CartIcon */], null),
                          quick_view_jsx(
                            ButtonText,
                            null,
                            quick_view_jsx(
    ...
    /* harmony default export */ var quick_view = (__webpack_exports__[
      'default'
    ] = QuickView);
