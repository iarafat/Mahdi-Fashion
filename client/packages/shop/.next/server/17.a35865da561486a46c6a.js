...
const SidebarCategory = ({
  ...
  return sidebar_jsx(CategoryWrapper, null, sidebar_jsx(PopoverWrapper, null, sidebar_jsx(popover["a" /* default */], {
    handler: sidebar_jsx(PopoverHandler, null, sidebar_jsx("div", null, sidebar_jsx(CategoryIcon["a" /* CategoryIcon */], null), "Select your Category"), sidebar_jsx("div", null, sidebar_jsx(ArrowDropDown["a" /* ArrowDropDown */], null))),
    className: "category-popover",
    content: sidebar_jsx(external_react_default.a.Fragment, null, type === 'medicine' && sidebar_jsx(link_default.a, {
      href: site_navigation["p" /* REQUEST_MEDICINE_MENU_ITEM */].href
    }, sidebar_jsx(RequestMedicine, null, sidebar_jsx(external_react_intl_["FormattedMessage"], {
      id: site_navigation["p" /* REQUEST_MEDICINE_MENU_ITEM */].id,
      defaultMessage: site_navigation["p" /* REQUEST_MEDICINE_MENU_ITEM */].defaultMessage
