...
exports.modules = {
  ...
  /***/ '8XX/': /***/ function (
    ...
    __webpack_require__.d(
      category_icons_namespaceObject,
      'Accessories',
      function () {
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Dairy', function () {
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Eyes', function () {
      return Eyes['a' /* Eyes */];
    });
    __webpack_require__.d(category_icons_namespaceObject, 'Face', function () {
      return Face['a' /* Face */];
    });
    __webpack_require__.d(
      category_icons_namespaceObject,
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Lips', function () {
      return Lips['a' /* Lips */];
    });
    __webpack_require__.d(
      category_icons_namespaceObject,
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Minus', function () {
      return PlusMinus['a' /* Minus */];
    });
    __webpack_require__.d(category_icons_namespaceObject, 'Plus', function () {
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Pants', function () {
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Purse', function () {
    ...
    __webpack_require__.d(category_icons_namespaceObject, 'Tops', function () {
      return Tops['a' /* Tops */];
    });
    __webpack_require__.d(
      category_icons_namespaceObject,
    ...
    const Fade = Object(external_styled_components_['keyframes'])([
    ...
    var external_resize_observer_polyfill_default = /*#__PURE__*/ __webpack_require__.n(
      external_resize_observer_polyfill_
    );
    ...
    function usePrevious(value) {
      ...
      Object(external_react_['useEffect'])(() => void (ref.current = value), [
        value,
      ]);
      return ref.current;
    }
    function useMeasure() {
      const ref = Object(external_react_['useRef'])();
      const { 0: bounds, 1: set } = Object(external_react_['useState'])({
        left: 0,
        top: 0,
        width: 0,
        height: 0,
      });
      const { 0: ro } = Object(external_react_['useState'])(
        () =>
          new external_resize_observer_polyfill_default.a(([entry]) =>
    ...
    const Content = external_styled_components_default()(
    ...
    const Tree = external_react_default.a.memo(
      ({
        ...
        const { height, opacity, transform } = Object(
          external_react_spring_['useSpring']
        )({
          from: {
            height: 0,
            opacity: 0,
        ...
        const Icon = icon
          ? category_icons_namespaceObject[icon]
          : depth === 'child'
          ? PlusMinus['a' /* Minus */]
          : null;
        return __jsx(
    ...
    const TreeMenu = ({ data, className, onClick, active }) => {
    ...
    const SidebarCategory = ({
      ...
      const { data, loading } = Object(react_hooks_['useQuery'])(
        category_query['a' /* GET_CATEGORIES */],
        {
          variables: {
      ...
      const isSidebarSticky = Object(app_provider['c' /* useAppState */])(
        'isSidebarSticky'
      );
          ...
          sidebar_jsx(popover['a' /* default */], {
            handler: sidebar_jsx(
              ...
              sidebar_jsx(
                'div',
                null,
                sidebar_jsx(CategoryIcon['a' /* CategoryIcon */], null),
                'Select your Category'
              ),
              sidebar_jsx(
                'div',
                null,
                sidebar_jsx(ArrowDropDown['a' /* ArrowDropDown */], null)
              )
            ),
            ...
            content: sidebar_jsx(
              ...
              type === 'medicine' &&
                sidebar_jsx(
                  ...
                  {
                    href:
                      site_navigation['p' /* REQUEST_MEDICINE_MENU_ITEM */]
                        .href,
                  },
                  sidebar_jsx(
                    RequestMedicine,
                    null,
                    sidebar_jsx(external_react_intl_['FormattedMessage'], {
                      id:
                        site_navigation['p' /* REQUEST_MEDICINE_MENU_ITEM */]
                          .id,
                      defaultMessage:
          ...
          sidebar_jsx(
            ...
            type === 'medicine' &&
              sidebar_jsx(
                ...
                {
                  href:
                    site_navigation['p' /* REQUEST_MEDICINE_MENU_ITEM */].href,
                },
                sidebar_jsx(
                  RequestMedicine,
                  null,
                  sidebar_jsx(external_react_intl_['FormattedMessage'], {
                    id:
                      site_navigation['p' /* REQUEST_MEDICINE_MENU_ITEM */].id,
                    defaultMessage:
                      site_navigation['p' /* REQUEST_MEDICINE_MENU_ITEM */]
                        .defaultMessage,
                  })
    ...
    /* harmony default export */ var sidebar = (__webpack_exports__[
      'default'
    ] = SidebarCategory);
  ...
  /***/ Sagj: /***/ function (
    ...
    /* harmony import */ var react_content_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      'EGWi'
    );
    /* harmony import */ var react_content_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/ __webpack_require__.n(
      react_content_loader__WEBPACK_IMPORTED_MODULE_1__
    );
    var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
    ...
    const PostLoader = (props) =>
      __jsx(
        react_content_loader__WEBPACK_IMPORTED_MODULE_1___default.a,
        _extends(
          {
            height: 350,
            width: 245,
