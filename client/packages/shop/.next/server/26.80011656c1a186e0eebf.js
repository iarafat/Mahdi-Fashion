...
})(["margin-top:60px;@media (max-width:767px){margin-top:40px;}.cart-button{font-family:", ";font-size:", "px;font-weight:", ";color:", ";height:36px;border-radius:4rem;.btn-icon{margin-right:5px;}svg{@media (max-width:767px){margin-right:0;}}&:hover{color:", ";background-color:", ";border-color:", ";}}"], Object(theme_get_["themeGet"])('fonts.body', 'Lato'), Object(theme_get_["themeGet"])('fontSizes.base', '15'), Object(theme_get_["themeGet"])('fontWeights.bold', '700'), Object(theme_get_["themeGet"])('colors.primary.regular', '#009e7f'), Object(theme_get_["themeGet"])('colors.white', '#ffffff'), Object(theme_get_["themeGet"])('colors.primary.regular', '#009e7f'), Object(theme_get_["themeGet"])('colors.primary.regular', '#009e7f'));
...
const QuickView = ({
  ...
  return __jsx(external_react_default.a.Fragment, null, __jsx(ModalClose, {
  ...
  }, __jsx(CloseIcon["a" /* CloseIcon */], null)), __jsx(QuickViewWrapper, null, __jsx(ProductDetailsWrapper, {
    className: "product-card",
    dir: "ltr"
  }, !isRtl && __jsx(ProductPreview, null, __jsx(multi_carousel["a" /* default */], {
    items: gallery,
    ...
    character: 600
  }, description)), __jsx(ProductCartWrapper, null, __jsx(ProductCartBtn, null, !isInCart(id) ? __jsx(button_button["a" /* Button */], {
    className: "cart-button",
    variant: "secondary",
    borderRadius: 100,
    onClick: handleAddClick
  }, __jsx(CartIcon["a" /* CartIcon */], {
    mr: 2
    ...
    key: item.id
  }, item.title)) : '')))), isRtl && __jsx(ProductPreview, null, __jsx(multi_carousel["a" /* default */], {
    items: gallery,
    deviceType: deviceType
...
const SingleItem = styled_components__WEBPACK_IMPORTED_MODULE_3___default.a.li.withConfig({
  displayName: "multi-carousel__SingleItem",
  componentId: "sc-1is9f8u-0"
})(["border:1px solid ", ";border-radius:", ";margin-right:20px;padding:0;outline:none;width:70px;height:auto;overflow:hidden;&:last-child{margin-right:0;}&.custom-dot--active{border:2px solid ", ";}"], Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('colors.gray.500', '#f1f1f1'), Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('radii.base', '6px'), Object(_styled_system_theme_get__WEBPACK_IMPORTED_MODULE_1__["themeGet"])('colors.primary.regular', '#009E7F'));
const responsive = {
  desktop: {
    breakpoint: {
      max: 3000,
