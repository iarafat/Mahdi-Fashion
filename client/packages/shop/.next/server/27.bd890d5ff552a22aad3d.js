...
exports.modules = {
  ...
  /***/ qr0j: /***/ function (
    ...
    /* harmony import */ var components_image_image__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      'dFr0'
    );
    /* harmony import */ var _product_card_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      'ZhUJ'
    );
    var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
    ...
    const ProductCard = ({ title, image, discountInPercent, onClick }) => {
      return __jsx(
        _product_card_style__WEBPACK_IMPORTED_MODULE_2__[
          /* ProductCardWrapper */ 'g'
        ],
        {
          onClick: onClick,
        ...
        __jsx(
          _product_card_style__WEBPACK_IMPORTED_MODULE_2__[
            /* ProductImageWrapper */ 'h'
          ],
          null,
          __jsx(
            components_image_image__WEBPACK_IMPORTED_MODULE_1__[
              /* default */ 'a'
            ],
            {
              url: image,
