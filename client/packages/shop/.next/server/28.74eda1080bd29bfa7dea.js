...
const ProductCard = (_ref) => {
  ...
  return __jsx(product_card_style["l" /* ProductCardWrapper */], {
    onClick: onClick,
    ...
    alt: title
  }), discountInPercent ? __jsx(external_react_default.a.Fragment, null, __jsx(product_card_style["h" /* DiscountPercent */], null, discountInPercent, "%")) : ''), __jsx(product_card_style["n" /* ProductInfo */], null, __jsx("h3", {
  ...
  }, currency, salePrice ? salePrice : price)), !isInCart(data.id) ? __jsx(button_button["a" /* Button */], {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return ProductCardWrapper; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return DiscountPercent; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return ProductName; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return FoodCardWrapper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return FoodImageWrapper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return ProductMeta; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return DeliveryOpt; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return Category; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return Duration; });
