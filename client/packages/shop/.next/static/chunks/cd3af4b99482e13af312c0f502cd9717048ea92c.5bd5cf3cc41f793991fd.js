  ...
  [13],
  {
    ...
    fALc: function (e, t, r) {
      ...
      (n = new (function () {
        var e =
          ...
          b = new RegExp('(^|[^a-zA-Z])(left)(?![a-zA-Z])' + c + l, 'gi'),
          v = new RegExp('(^|[^a-zA-Z])(right)(?![a-zA-Z])' + c + l, 'gi'),
          y = new RegExp('(^|[^a-zA-Z])(left)' + s, 'gi'),
          w = new RegExp('(^|[^a-zA-Z])(right)' + s, 'gi'),
          x = new RegExp('(^|[^a-zA-Z])(ltr)' + s, 'gi'),
          R = new RegExp('(^|[^a-zA-Z])(rtl)' + s, 'gi'),
          ...
          I = new RegExp('(box-shadow\\s*:\\s*(?:inset\\s*)?)' + n, 'gi'),
          k = new RegExp('(text-shadow\\s*:\\s*)' + n + '(\\s*)' + a, 'gi'),
          _ = new RegExp('(text-shadow\\s*:\\s*)' + a + '(\\s*)' + n, 'gi'),
          z = new RegExp('(text-shadow\\s*:\\s*)' + n, 'gi'),
          D = new RegExp(
        ...
        function A(e, t, r) {
          ...
          return (
            '%' === r.slice(-1) &&
              (-1 !== (n = r.indexOf('.'))
                ? ((o = r.length - n - 2),
                  (r = (r = 100 - parseFloat(r)).toFixed(o) + '%'))
                : (r = 100 - parseFloat(r) + '%')),
            t + r
          );
        }
        ...
        function L(e, t) {
          var r = [].slice.call(arguments),
            ...
            a = r[10] || '';
          return t + (o.length ? M(n) + ' / ' + M(o) : M(n)) + a;
        }
        function N(e) {
        ...
        return {
          transform: function (e, t) {
            var r = new o(m, '`NOFLIP_SINGLE`'),
              n = new o(d, '`NOFLIP_CLASS`'),
              a = new o(p, '`COMMENT`');
            return (
              (e = a.tokenize(n.tokenize(r.tokenize(e.replace('`', '%60'))))),
              t.transformDirInUrl &&
                (e = e
                  .replace(x, '$1`TMP`')
                  .replace(R, '$1ltr')
              ...
              (e = e
                ...
                .replace(S, A)
                .replace(F, A)),
              (e = r.detokenize(n.detokenize(a.detokenize(e))))
            );
          },
        };
      })()),
          ...
          ? (t.transform = function (e, t, r) {
              ...
              return (
                'object' === typeof t
                  ? (o = t)
                  : ((o = {}),
                    'boolean' === typeof t && (o.transformDirInUrl = t),
                    'boolean' === typeof r && (o.transformEdgeInUrl = r)),
                n.transform(e, o)
              );
            })
        ...
        return (function r(n) {
          ...
          function a(t, r, a) {
            if ('undefined' !== typeof document) {
              'number' ===
                typeof (a = e({ path: '/' }, o.defaults, a)).expires &&
            ...
            (function (e) {
            ...
            })(
              {
                ...
                body: {
                  ...
                  transition: Object(a.e)(t, 'customs.transition'),
                },
    ...
    uiyz: function (e, t, r) {
      ...
      function u(e, t, r) {
        ...
        return t(n, Object(l.d)(r, s, c));
      }
      function f(e, t, r, n) {
        void 0 === n && (n = {});
        try {
          return u(e, t, n).format(r);
        } catch (o) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting number.', o));
        }
        return String(r);
      }
      function p(e, t, r, n) {
        void 0 === n && (n = {});
        try {
          return u(e, t, n).formatToParts(r);
        } catch (o) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting number.', o));
        }
        return [];
      ...
      function g(e, t, r, n, o) {
        ...
        try {
          return (function (e, t, r) {
            ...
            return t(n, Object(l.d)(r, d, c));
          })(e, t, o).format(r, n);
        } catch (a) {
          e.onError(new c.b('Error formatting relative time.', a));
        }
        return String(r);
      }
      var h = function () {
      ...
      function v(e, t, r, n) {
        ...
        void 0 === n && (n = {});
        var s = n.format,
          u = h(h({}, c && { timeZone: c }), s && Object(l.e)(a, t, s, i)),
          f = Object(l.d)(n, b, u);
        return (
          'time' !== t ||
            f.hour ||
      ...
      function y(e, t, r, n) {
        ...
        try {
          return v(e, 'date', t, n).format(o);
        } catch (a) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting date.', a));
        }
        return String(o);
      }
      function w(e, t, r, n) {
        ...
        var o = 'string' === typeof r ? new Date(r || 0) : r;
        try {
          return v(e, 'time', t, n).format(o);
        } catch (a) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting time.', a));
        }
        return String(o);
      }
      function x(e, t, r, n) {
        ...
        var o = 'string' === typeof r ? new Date(r || 0) : r;
        try {
          return v(e, 'date', t, n).formatToParts(o);
        } catch (a) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting date.', a));
        }
        return [];
      ...
      function R(e, t, r, n) {
        ...
        var o = 'string' === typeof r ? new Date(r || 0) : r;
        try {
          return v(e, 'time', t, n).formatToParts(o);
        } catch (a) {
          e.onError(new c.e('FORMAT_ERROR', 'Error formatting time.', a));
        }
        return [];
      ...
      function O(e, t, r, n) {
        ...
        var i = Object(l.d)(n, E);
        try {
          return t(o, i).select(r);
        } catch (s) {
          a(new c.b('Error formatting plural.', s));
        }
        return 'other';
      }
      var T = r('5G9k'),
      ...
      function I(e, t, r, n) {
        ...
        try {
          ...
          a(new c.e('FORMAT_ERROR', 'Error formatting list.', f));
        }
        return r;
      }
      var k = ['localeMatcher', 'style', 'type', 'fallback'];
      function _(e, t, r, n) {
        var o = e.locale,
          a = e.onError;
        void 0 === n && (n = {}),
        ...
        var i = Object(l.d)(n, k);
        try {
          return t(o, i).of(r);
        } catch (s) {
          a(new c.e('FORMAT_ERROR', 'Error formatting display name.', s));
        }
      }
      var z = (function () {
          var e = function (t, r) {
      ...
      function M(e, t) {
        ...
        return (
          ...
          D(D({}, n), {
            ...
            formatTimeToParts: R.bind(null, n, r.getDateTimeFormat),
            formatPlural: O.bind(null, n, r.getPluralRules),
            formatMessage: T.a.bind(null, n, r),
            formatList: I.bind(null, n, r.getListFormat),
            formatDisplayName: _.bind(null, n, r.getDisplayNames),
          })
        );
      }
      var L = (function (e) {
          function t() {
            ...
            return (
              ...
              (t.state = {
                cache: t.cache,
                intl: M(A(t.props), t.cache),
                prevConfig: A(t.props),
              }),
              t
            );
          }
          return (
            ...
            (t.getDerivedStateFromProps = function (e, t) {
              var r = t.prevConfig,
                n = t.cache,
                o = A(e);
              return C(r, o) ? null : { intl: M(o, n), prevConfig: o };
            }),
        ...
        H = function (e) {
          ...
          return X(
            ...
            X(
              ...
              X(
                N.b,
                { lang: l, dir: u ? 'rtl' : 'ltr' },
                X(J.a, { stylisPlugins: u ? [W.a] : [] }, t)
              )
            )
          );
        },
        K = function () {
          return a.a.useContext(q);
        };
    },
  },
]);
