      ...
      var r = n('ERkP'),
        ...
        l = function (e) {
          ...
          return c(
            ...
            l && c('meta', { name: 'twitter:image', content: ''.concat(l) }),
      ...
      t.default = function () {
        ...
        return (function (c) {
          ...
          function s(e) {
            var a;
            return (
              r(this, s), (a = l.call(this, e)), f && (t.add(o(a)), n(o(a))), a
            );
          }
          return (
            a(s, null, [
        ...
        function n(e) {
          ...
          return (
            ...
            (o.formatUrls = (function (e) {
              ...
              return {
                href: (0, v.addBasePath)(g(e)),
                as: t ? (0, v.addBasePath)(g(t)) : t,
              };
            })),
            (o.linkClicked = function (e) {
              ...
              if (
                ...
                if (
                  ...
                  (i = (0, p.resolve)(l, i)),
                    (c = c ? (0, p.resolve)(l, c) : i),
                    e.preventDefault();
                  var s = o.props.scroll;
                  null == s && (s = c.indexOf('#') < 0),
                    h.default[o.props.replace ? 'replace' : 'push'](i, c, {
    ...
    jvDv: function (e, t, n) {
      ...
      var r = n('Km8e'),
            ...
            r = function (e) {
              ...
              for (var p in e)
                if (t[p]) {
                  ...
                  if ('object' !== typeof h) o()(r, m(h, v, e));
                  else {
                    if (
                      ((n.breakpoints =
                        (!u && n.breakpoints) ||
                        s(e.theme, 'breakpoints', i.breakpoints)),
                      Array.isArray(h))
                    ) {
                      (n.media =
                        (!u && n.media) || [null].concat(n.breakpoints.map(c))),
                        (r = a(r, d(n.media, m, v, h, e)));
                      continue;
                    }
                    null !== h &&
                      ((r = a(r, f(n.breakpoints, m, v, h, e))), (l = !0));
                  }
                }
              return (
                l &&
        ...
        d = function (e, t, n, r, a) {
          var i = {};
          return (
            r.slice(0, e.length).forEach(function (r, c) {
              var l,
                s = e[c],
                u = t(r, n, a);
              s ? o()(i, (((l = {})[s] = o()({}, i[s], u)), l)) : o()(i, u);
            }),
            i
          );
        },
      ...
      var r = n('ERkP'),
        ...
        h = f.e.div.withConfig({
          ...
          [
            ...
            ';overflow:hidden;position:relative;width:calc(100% - 30px);margin-left:auto;margin-right:auto;@media (min-width:991px){width:870px;}@media (max-width:990px){padding:50px 45px;}@media (max-width:767px){padding:50px 25px;}.home-btn{display:inline-flex;align-items:center;justify-content:center;font-family:',
            ';font-size:',
            'px;font-weight:',
            ';color:',
            ';padding:5px 15px;height:36px;border:1px solid ',
            ';border-radius:',
            ';position:absolute;top:15px;right:15px;transition:0.15s ease-in-out;@media (max-width:767px){font-size:',
            'px;height:34px;padding:5px 12px;}&:hover{background-color:',
            ';border-color:',
            ';color:',
            ';}}.print-btn{display:inline-flex;align-items:center;justify-content:center;font-family:',
            ';font-size:',
            'px;font-weight:',
            ';color:',
            ';padding:5px 15px;height:36px;border:1px solid ',
            ';border-radius:',
            ';position:absolute;top:15px;right:165px;cursor:pointer;transition:0.15s ease-in-out;@media (max-width:767px){font-size:',
            'px;height:34px;padding:5px 12px;}&:hover{background-color:',
            ';border-color:',
            ';color:',
            ';}}@media print{.print-btn,.home-btn{display:none;}}',
          ],
        ...
        b = f.e.h2.withConfig({
          ...
          [
            ...
            'px;font-weight:',
            ';color:',
            ';line-height:1;margin-bottom:32px;@media (max-width:767px){font-size:calc(',
            'px + 1px);margin-bottom:25px;}',
          ],
        ...
        x = f.e.p.withConfig({
          ...
          Object(p.a)('colors.text.medium', '#424561')
        ),
        ...
        S = o.a.createElement,
        E = function (e) {
          var t = Object(l.useRouter)(),
            n = Object(s.b)(u.a),
            r = n.data,
            o = n.error;
          if (n.loading) return S(d.default, { message: 'Loading...' });
          if (o) return S(d.default, { message: o.message });
          var a = r.getUserOrders
              .map(function (e) {
                return e.id;
              })
              .indexOf(t.query.itemId),
            i = r.getUserOrders[a];
          return S(
            C,
            null,
            S(
              ...
              S(
                ...
                S(
                  'a',
                  { className: 'home-btn' },
                  S(M.a, { id: 'backHomeBtn', defaultMessage: 'Back to Home' })
                )
              ),
              S(
                'span',
              ...
              S(
                ...
                S(
                  b,
                  null,
                  S(M.a, { id: 'orderReceivedText', defaultMessage: 'Order' })
                ),
                S(
                  w,
                  null,
                  ...
                  S(
                    ...
                    S(
                      x,
                      { bold: !0, className: 'title' },
                      S(M.a, { id: 'orderDateText', defaultMessage: 'Date' })
                    ),
                    S(x, null, i.datetime.split('2020').shift())
                  ),
                  S(
                    _,
                    null,
                    S(
                      x,
                      { bold: !0, className: 'title' },
                      S(M.a, { id: 'totalText', defaultMessage: 'Total' })
                    ),
                    S(x, null, i.total)
                  ),
                  S(
                    ...
                    S(
                      ...
                      S(M.a, {
                        ...
                        defaultMessage: i.payment_method,
                      })
                    )
                  )
                )
              ...
              S(
                ...
                S(
                  ...
                  S(j, null, S(x, null, i.delivery_method.details))
                ),
                S(
                  O,
                  null,
                  ...
                  S(j, null, S(x, null, i.delivery_address))
                )
              ),
              S(
                y,
                ...
                S(
                  ...
                  S(
                    ...
                    S(
                      x,
                      { bold: !0 },
                      S(M.a, { id: 'subTotal', defaultMessage: 'Sub total' })
                    )
                  ),
                  S(j, null, S(x, null, i.sub_total))
                ),
                S(
                  O,
                  null,
                  ...
                  S(j, null, S(x, null, i.payment_method))
                ),
                S(
                  O,
                  null,
