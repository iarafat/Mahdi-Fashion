(window.webpackJsonp = window.webpackJsonp || []).push([
    ...
    '6A1X': function (t, e, n) {
      ...
      var ae = function (t) {
        ...
        se = function (t) {
          ...
          var e = t.deviceType,
            ...
            L = D.coupon,
            R = D.applyCoupon,
            N = (D.clearCart, D.cartItemsCount),
            W = D.calculatePrice,
            V = D.calculateDiscount,
            B = D.calculateSubTotalPrice,
            F = (D.isRestaurant, D.toggleRestaurant, null);
          z.length > 0 &&
            (F = z.map(function (t, e) {
              return {
                product_id: t.id,
                unit: t.unit,
                quantity: t.quantity,
          ...
          var U = Object(r.useState)(!1),
            ...
            K = Q[0],
            Y = Q[1],
            J = I.delivery_address,
            $ = (I.contact, I.paymentMethods),
            it = I.phones,
            rt = (I.name, I.email, I.id),
            at = I.deliveryMethods,
            st = Object(c.a)(nt.c),
            lt = Object(g.a)(st, 1)[0],
            dt = Object(c.a)(nt.b),
            gt = Object(g.a)(dt, 1)[0],
            Lt = Object(c.a)(ot.c),
            Rt = Object(g.a)(Lt, 1)[0],
            Nt = Object(c.a)(ot.b),
            Wt = Object(g.a)(Nt, 1)[0],
            Vt = Object(c.a)(ct),
            Jt = (Object(g.a)(Vt, 1)[0], Object(c.a)(ht.a)),
            ie = (Object(g.a)(Jt, 1)[0], Object(c.a)(pt.a)),
            se =
              (Object(g.a)(ie, 1)[0],
              (function () {
            ...
            le = Object(c.a)(ut),
            ce = Object(g.a)(le, 1)[0],
            de = J.find(function (t) {
              return !0 === t.is_primary;
            }),
            ue = it.find(function (t) {
              return !0 === t.is_primary;
            });
          Object(r.useEffect)(
            function () {
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 8:
                          ...
                          return (
                            A({ type: 'DELETE_CONTACT', payload: e.id }),
                            (t.next = 12),
                            Wt({ variables: { id: rt, phoneId: e.id } })
                          );
                        case 12:
                        ...
                        case 16:
                          ...
                          return (
                            A({ type: 'DELETE_ADDRESS', payload: e.id }),
                            (t.next = 20),
                            gt({ variables: { id: rt, addressId: e.id } })
                          );
                        case 20:
                          return t.abrupt('return', t.sent);
                        case 23:
                  ...
                  return f.a.wrap(function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          return (
                            A({ type: 'SET_PRIMARY_CONTACT', payload: e.id }),
                            (t.next = 6),
                            Rt({ variables: { id: rt, phoneId: e.id } })
                          );
                        case 6:
                          return t.abrupt('return', t.sent);
                        case 7:
                          return (
                            A({ type: 'SET_PRIMARY_ADDRESS', payload: e.id }),
                            (t.next = 10),
                            lt({ variables: { id: rt, addressId: e.id } })
                          );
                        case 10:
                          return t.abrupt('return', t.sent);
                        case 11:
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          ...
                          return j('Invalid Coupon'), t.abrupt('return', null);
                        case 3:
                          return (t.next = 5), ce({ variables: { code: l } });
                        case 5:
                          if (
                            ((e = t.sent),
                            (n = e.data),
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          if (
                            ...
                            (n = K.contact_number),
                            (o = K.payment_option_id),
                            (i = K.delivery_method_id),
                            (r = K.delivery_address),
                            K.coupon_code,
                            (a = K.products),
                            (l = e.sub_total),
                            (c = e.total),
                            (d = e.discount_amount),
                            (s = e.customer_id) && n && r && i && o && a)
                          ) {
                            t.next = 6;
                            break;
                          }
                          return (
                            _('Please place a valid order!'),
                            t.abrupt('return', null)
                          );
                        case 6:
                          console.log('customer_id', s),
                            console.log('contact_number', n),
                            console.log('delivery_address', r),
                            console.log('delivery_method_id', i),
                            console.log('payment_option_id', o),
                            console.log('products', a),
                            console.log('total', c),
                            console.log('sub_total', l),
                            console.log('discount_amount', d);
                        case 15:
                        case 'end':
                          return t.stop();
                      }
                      ...
                      oe(x.a, {
                        ...
                        component: function (t, e) {
                          return oe(k.a, {
                            ...
                            onEdit: function () {
                              return he(t, e, 'edit', 'address');
                            },
                            onDelete: function () {
                              return he(t, e, 'delete', 'address');
                            },
                          });
                        },
                            ...
                            onClick: function () {
                              return Y(
                                re(
                                  re({}, K),
                                  {},
                                  { delivery_method_id: t.id, products: F }
                                )
                              );
                            },
                            onChange: function () {
                            ...
                            onClick: function () {
                              return Y(
                                re(
                                  re({}, K),
                                  {},
                                  { contact_number: t.number, products: F }
                                )
                              );
                            },
                            name: 'contact',
                            onEdit: function () {
                              return he(t, e, 'edit', 'contact');
                            },
                            onDelete: function () {
                              return he(t, e, 'delete', 'contact');
                            },
                          });
                        },
                        secondaryComponent: oe(
                  ...
                  oe(
                        ...
                        return (
                          Y(
                            re(
                              re({}, K),
                              {},
                              { payment_option_id: t.id, products: F }
                            )
                          ),
                          null
                        );
                    ...
                    T &&
                      oe(
                        Et,
                        null,
                        oe(S.a, { id: 'checkoutError', defaultMessage: T })
                      )
                  )
                ),
                oe(
                  ...
                  oe(
                    $t.a,
                    { enabled: se.width >= 768, top: 120, innerZ: 999 },
                    oe(
                      Pt,
                      null,
                      oe(
                            ...
                            return oe(
                              ...
                              Object(p.a)({}, t, {
                                style: re(
                                  ...
                                  {},
                                  {
                                    marginLeft: P ? t.style.marginRight : 0,
                                    marginRight: P ? 0 : t.style.marginRight,
                                    paddingLeft: P ? 15 : 0,
                                    paddingRight: P ? 0 : 15,
                                  }
                                ),
      ...
      e.default = function (t) {
        var e = t.deviceType,
          ...
          y = g.error,
          v = g.loading;
        if (s || m || v) return me(fe.default, { message: 'Loading...' });
        if (r || f || y)
          return (
            setTimeout(function () {
              l.a.push('/');
        ...
        return (
          (i.getUser = be(
            ...
            {},
            {
              deliveryMethods: Object(o.a)(h.deliveryMethods.items),
              paymentMethods: Object(o.a)(b.paymentOptions.items),
            }
          )),
          me(
            a.a.Fragment,
  ...
  [['/SUl', 1, 0, 2, 4, 3, 5, 7, 6, 9, 10, 12, 13]],
]);
