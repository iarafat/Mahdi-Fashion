  ...
  [21],
  {
    ...
    Ek28: function (t, e, n) {
      ...
      e.a = Object(l.withRouter)(function (t) {
        var e = t.href,
          ...
          p = t.iconClass,
          h = t.dynamic,
          f = o.pathname === e || o.asPath === e;
        return u(
          'div',
          { onClick: l, className: a || '' },
          u(
            s.a,
            h ? { href: '/[type]', as: e } : { href: e },
            u(
              'a',
              {
    ...
    YVsU: function (t, e, n) {
      ...
      e.default = function (t) {
        ...
        var f,
          ...
          y = i.Children.toArray(h);
        f = p ? Math.ceil(y.length / g) : Math.ceil((y.length - v) / g) + 1;
        var w = r.getLookupTableForNextSlides(f, n, e, y),
      ...
      (e.notEnoughChildren = o),
        (e.getInitialState = function (t, e) {
          var n,
            ...
            p = e.partialVisible,
            h = Boolean(o && r && a && s);
          u && l && !h && (n = i.getWidthFromDeviceType(l, c));
          var f = Boolean(u && l && !h && n);
          return {
            shouldRenderOnSSR: f,
            flexBisis: n,
            domFullyLoaded: h,
    ...
    fUjb: function (t, e, n) {
      ...
      e.populatePreviousSlides = function (t, e, n) {
        ...
        var a,
          ...
          m = l - n - (0 < n ? 0 : f),
          v = (i.Children.toArray(d).length - u) % f;
        return (
          (s =
            0 <= m
              ? ((a = m),
                p && !h && 0 < v && r.isInRightEnd(t) && (a = l - v),
                -c * a)
              : (a = m < 0 && 0 !== l ? 0 : void 0)),
    ...
    roL4: function (t, e, n) {
      ...
      var i = n('ERkP'),
        ...
        C = n('W1nP'),
        P = o.a.createElement,
        _ = Object(d.e)('button').withConfig({
        ...
        E = Object(d.e)('button').withConfig({
      ...
      var D,
        ...
        z = d.e.div.withConfig({
          ...
          Object(L.a)({ backgroundSize: ['cover'] }),
          {
            width: '100%',
            height: '100%',
        ...
        Z = function (t) {
          ...
          return U(
            W,
            null,
            U(z, { backgroundImage: 'url('.concat(e, ')') }),
            U(
              V,
              null,
              U(
        ...
        dt = n('tfq8'),
        pt = n.n(dt),
        ht = (tt.a, nt.a, ot.a, at.a, ut.a, lt.a, pt.a, n('H8eV')),
        ft = n('zjfJ'),
        mt = !(!window.document || !window.document.createElement);
      function vt(t, e) {
        var n = Object.keys(t);
        if (Object.getOwnPropertySymbols) {
      ...
      function yt(t) {
        var e = t.percentOfElement,
          ...
          s = void 0 !== a && a,
          l = t.container,
          c = void 0 === l ? (mt ? window : null) : l,
          u = t.percentOfContainer,
          d = void 0 === u ? 50 : u,
          p = t.direction,
          h = void 0 === p ? D.Vertical : p,
              ...
              f.current &&
                (function (t, e) {
                  var n = e.container,
                    ...
                    p = (c * i) / 100;
                  o && (p += o);
                  var h = (l ? n.scrollY : n.scrollX) + u + ((d * a) / 100 + p),
                    f = l ? { top: h } : { left: h };
                  window.scrollTo(gt(gt({}, f), {}, { behavior: 'smooth' }));
                })(f, {
                  percentOfElement: n,
                  offsetPX: r,
                  container: c,
      ...
      var Ot = n.n(xt)()(St()),
        ...
        Et = a()(
          function () {
            return Promise.all([n.e(8), n.e(15)]).then(n.bind(null, 'SZ6D'));
          },
          {
            loadableGenerated: {
              webpack: function () {
        ...
        kt = a()(
          function () {
            return Promise.all([n.e(6), n.e(8), n.e(15)]).then(
              n.bind(null, 'gZAk')
            );
          },
          {
      ...
      e.default = function (t) {
        ...
        var u = n.type,
          d = Object(c.b)(Ot, { variables: { type: u } }),
          p = d.data,
          h = d.loading,
          f = d.error,
          m = Object(c.b)(wt.a, { variables: { searchText: u } }),
          v = m.data,
          y = m.loading,
          w = m.error;
        if (y || h) return Pt(Ct.default, { message: 'Loading...' });
        if (w || f)
          return Pt(
            Ct.default,
            w ? { message: w.message } : { message: f.message }
          );
        var b = v.types.items[0],
          x = b.home_title,
          S = b.home_subtitle,
          O = b.image;
        return Pt(
          o.a.Fragment,
          null,
          Pt(ht.a, { title: x, description: S }),
          Pt(
            l.a,
            null,
            Pt(Z, { intlTitleId: x, intlDescriptionId: S, imageUrl: C.a + O }),
            Pt(
              K,
              null,
              Pt(g, { items: Tt.e }),
              Pt(_t, { type: u, deviceType: e })
            ),
            p.getHomeCards.length > 0
              ? Pt(
                  J,
                  null,
                  Pt(
                    'div',
                    { style: { margin: '0 -10px' } },
                    Pt(R, { deviceType: e, data: p.getHomeCards })
                  )
                )
              : Pt('div', null),
            Pt(
              Y,
              null,
              Pt(Q, null, Pt(_t, { type: u, deviceType: e })),
              Pt(
                q,
                null,
                Pt(
                  'div',
                  { ref: r },
                  Pt(Et, { type: u, deviceType: e, fetchLimit: 20 })
                )
              )
            ),
            Pt(kt, { deviceType: e })
