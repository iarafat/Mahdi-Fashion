      ...
      (function (t) {
        !(function () {
          ...
          var N,
            ...
            U = M.inspectSource,
            F = o.WeakMap,
            D = 'function' == typeof F && /native code/.test(U(F)),
            B = r(function (t) {
          ...
          var Q,
            ...
            Ct = B('wks'),
            Ut = o.Symbol,
            Ft = Lt ? Ut : (Ut && Ut.withoutSetter) || K,
            Dt = function (t) {
              return (
                S(Ct, t) ||
                  (Ct[t] = Nt && S(Ut, t) ? Ut[t] : Ft('Symbol.' + t)),
                Ct[t]
              );
            },
            Bt =
          ...
          var qe = function (t, e, r, n) {
            ...
            Xe = Array.prototype,
            Ye = function (t) {
              return void 0 !== t && (Ne.Array === t || Xe[He] === t);
            },
            Je = function (t, e, r) {
              var n = m(e);
          ...
          var Ze = '[object z]' === String(Qe),
            ...
            nr = Dt('iterator'),
            or = function (t) {
              if (null != t) return t[nr] || t['@@iterator'] || Ne[rr(t)];
            },
            ir = Dt('iterator'),
            ar = function (t, e) {
              if (!e) return !1;
          ...
          It(
            { target: 'Reflect', stat: !0, forced: Ln },
            {
          ...
          var $n = {
              getConstructor: function (t, e, r, n) {
                var o = t(function (t, i) {
                    br(t, o, e),
                      Un(t, { type: e, id: Wn++, frozen: void 0 }),
                      null != i && mr(i, t[n], t, r);
                  }),
                  i = Fn(e),
                  a = function (t, e, r) {
          ...
          if (
            ...
            for (
              var Uo = function (t, e) {
                  ...
                  Lo
                    ...
                    Co &&
                      (r = !!e && e.indexOf('y') > -1) &&
                      (e = e.replace(/y/g, ''));
                  var a = Sr(Lo ? new To(t, e) : To(t, e), n ? this : Mo, Uo);
                  return Co && r && _o(a, { sticky: r }), a;
                },
                Fo = function (t) {
                  (t in Uo) ||
                    Ro(Uo, t, {
              ...
              Fo(Do[Bo++]);
            (Mo.constructor = Uo), (Uo.prototype = Mo), tt(o, 'RegExp', Uo);
          }
          Or('RegExp');
          ...
          var Ni = mt.f,
            ...
            Ui = {
              f: function (t) {
                return Ci && '[object Window]' == Li.call(t)
                  ? (function (t) {
                      try {
                        return Ni(t);
                      } catch (t) {
          ...
          It(
            { target: 'String', stat: !0, forced: !!La && 1 != La.length },
            {
              fromCodePoint: function (t) {
                for (
                  ...
                  n.push(
                    e < 65536
                      ? Na(e)
                      : Na(55296 + ((e -= 65536) >> 10), (e % 1024) + 56320)
                  );
                }
                return n.join('');
              },
          ...
          var Ca =
            ...
            Fa = function (t) {
              return function (e, r, n) {
                ...
                return s <= u || '' == c
                  ? a
                  : ((i = Ca.call(c, Ua((o = s - u) / c.length))).length > o &&
                      (i = i.slice(0, o)),
                    t ? a + i : i + a);
              };
            },
          ...
          It(
            ...
            It({ target: 'String', proto: !0 }, { repeat: Ca }),
            te('String', 'repeat');
          var Ka = A.f,
            Ga = ''.startsWith,
            $a = Math.min,
          ...
          ic &&
            ((Yu = function (t) {
              br(this, Yu, Vu), Jt(t), Lu.call(this);
              var e = qu(this);
              try {
            ...
            (Wu.f = ec = function (t) {
              return t === Yu || t === Uu ? new Cu(t) : rc(t);
            }),
            'function' == typeof ou &&
          ...
          (kc.prototype.clone = function () {
            ...
            Tc.call(Lc.prototype),
            (Lc.prototype.clone = function () {
              return new Lc(this._bodyInit, {
                status: this.status,
            ...
            (Lc.error = function () {
              var t = new Lc(null, { status: 0, statusText: '' });
              return (t.type = 'error'), t;
            });
          var Cc = [301, 302, 303, 307, 308];
          Lc.redirect = function (t, e) {
            if (-1 === Cc.indexOf(e))
              throw new RangeError('Invalid status code');
            return new Lc(null, { status: e, headers: { location: t } });
          };
            ...
            return new Promise(function (r, n) {
              ...
              (i.onload = function () {
                ...
                (n.url =
                  ...
                  r(new Lc('response' in i ? i.response : i.responseText, n));
              }),
                (i.onerror = function () {
