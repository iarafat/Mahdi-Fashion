    ...
    ioxi: function (e, t, n) {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 25:
                      ...
                      return (e.next = 29), window.__NEXT_PRELOADREADY(F);
                    case 29:
                      return (
                        (t.router = G = (0, v.createRouter)(N, M, L, {
                          initialProps: k,
                          pageLoader: H,
                          App: X,
                          Component: Q,
                        ...
                        K({ App: X, Component: Q, props: k, err: c }),
                        e.abrupt('return', z)
                      );
                    case 35:
                      e.next = 37;
          ...
          H.loadPage('/_error').then(function (r) {
            var o = r.page,
              ...
              i = {
                ...
                AppTree: a,
                router: G,
                ctx: { err: n, pathname: N, query: M, asPath: L, AppTree: a },
              };
            return Promise.resolve(
              e.props ? e.props : (0, S.loadGetInitialProps)(t, i)
            ).then(function (t) {
              return ue(
                (0, m.default)(
                  (0, m.default)({}, e),
                  {},
                  { err: n, Component: o, props: t }
                )
              );
            });
          })
      ...
      function ie(e) {
        ...
        return g.default.createElement(
          ...
          {
            fn: function (e) {
              return te({ App: X, err: e }).catch(function (e) {
                ...
                return this.promisedSsgManifest.then(function (o, a) {
                  return (
                    ...
                    !document.querySelector(
                      'link[rel="'.concat(d, '"][href^="').concat(a, '"]')
                    ) &&
                    v(a, d, 'fetch')
                  );
                });
