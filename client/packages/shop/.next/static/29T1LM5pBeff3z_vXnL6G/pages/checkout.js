(window.webpackJsonp = window.webpackJsonp || []).push([
      ...
      var ae = function (t) {
        ...
        se = function (t) {
          ...
          var e = t.deviceType,
            ...
            B = P.cartItemsCount,
            V = P.calculatePrice,
            F = P.calculateDiscount,
            U = P.calculateSubTotalPrice,
            G = (P.isRestaurant, P.toggleRestaurant, null);
          N.length > 0 &&
          ...
          var q = Object(r.useState)(!1),
            ...
            gt = Object(s.a)(nt.c),
            Ht = Object(f.a)(gt, 1)[0],
            Lt = Object(s.a)(nt.b),
            Rt = Object(f.a)(Lt, 1)[0],
            Wt = Object(s.a)(ot.c),
            Bt = Object(f.a)(Wt, 1)[0],
            Jt = Object(s.a)(ot.b),
            ie = Object(f.a)(Jt, 1)[0],
            se = Object(s.a)(ct),
            le = Object(f.a)(se, 1)[0],
            ce = Object(s.a)(ht.a),
            de = (Object(f.a)(ce, 1)[0], Object(s.a)(pt.a)),
            ue =
              (Object(f.a)(de, 1)[0],
              (function () {
                  ...
                  re(
                    ...
                    {},
                    {
                      delivery_address: 'Title: '
                        .concat(fe && fe.title, ', \n      District: ')
                        .concat(fe && fe.district, ',  \n      Division: ')
                        .concat(fe && fe.division, ',  \n      Region: ')
                        .concat(fe && fe.region, ',  \n      Division: ')
                        .concat(fe && fe.address, '\n      '),
                      products: G,
                    ...
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 8:
                          ...
                          return (
                            D({ type: 'DELETE_CONTACT', payload: e.id }),
                            (t.next = 12),
                        ...
                        case 16:
                          ...
                          return (
                            D({ type: 'DELETE_ADDRESS', payload: e.id }),
                            (t.next = 20),
                  ...
                  return p.a.wrap(function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 3:
                          return (
                            D({ type: 'SET_PRIMARY_CONTACT', payload: e.id }),
                            (t.next = 6),
                            Bt({ variables: { id: lt, phoneId: e.id } })
                          );
                        case 6:
                          return t.abrupt('return', t.sent);
                        case 7:
                          return (
                            D({ type: 'SET_PRIMARY_ADDRESS', payload: e.id }),
                            (t.next = 10),
                            Ht({ variables: { id: lt, addressId: e.id } })
                          );
                        case 10:
                          return t.abrupt('return', t.sent);
                        case 11:
                            ...
                            onClick: function () {
                              return it(
                                re(
                                  re({}, $),
                                  {},
                                  { delivery_method_id: t.id, products: G }
                                )
                              );
                            },
                            onChange: function () {
                            ...
                            onClick: function () {
                              return it(
                                re(
                                  re({}, $),
                                  {},
                                  { contact_number: t.number, products: G }
                                )
                              );
                            },
                            name: 'contact',
                        ...
                        return (
                          it(
                            re(
                              re({}, $),
                              {},
                              { payment_option_id: t.id, products: G }
                            )
                          ),
                          null
                        );
                            ...
                            return oe(
                              ...
                              Object(d.a)({}, t, {
                                style: re(
                                  ...
                                  {},
                                  {
                                    marginLeft: z ? t.style.marginRight : 0,
                                    marginRight: z ? 0 : t.style.marginRight,
                                    paddingLeft: z ? 15 : 0,
                                    paddingRight: z ? 0 : 15,
                                  }
                                ),
  ...
  [['/SUl', 1, 0, 2, 4, 3, 5, 7, 6, 9, 10, 12, 11, 19]],
]);
