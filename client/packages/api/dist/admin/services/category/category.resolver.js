...
let CategoryResolver = class CategoryResolver {
  ...
  categories(type, searchBy) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (type) {
        categories = yield categories.filter(
  ...
  category(id) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield this.categoriesCollection.find(
...
__decorate(
  [
    type_graphql_1.Mutation(() => category_type_1.default, {
...
CategoryResolver = __decorate([type_graphql_1.Resolver()], CategoryResolver);
