...
__decorate(
  [
    type_graphql_1.Query((returns) => [order_type_1.default], {
      description: 'Get all the Orders',
    }),
    __param(
      0,
      type_graphql_1.Arg('status', (type) => String, { nullable: true })
    ),
    __param(
      1,
    ...
    __param(
      2,
      type_graphql_1.Arg('searchText', (type) => String, { defaultValue: '' })
    ),
