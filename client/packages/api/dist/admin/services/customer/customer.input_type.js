...
const address_input_type_1 = __importDefault(
  require('../user/address/address.input_type')
);
const card_input_type_1 = __importDefault(
  require('../user/card/card.input_type')
);
const contact_input_type_1 = __importDefault(
  require('../user/contact/contact.input_type')
);
