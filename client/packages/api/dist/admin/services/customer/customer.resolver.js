...
let CustomerResolver = class CustomerResolver {
  ...
  customers(searchBy, sortBy, limit) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (sortBy === 'highestToLowest') {
        customers = yield sorts_1.sortByHighestNumber(
          customers,
          'total_order_amount'
        );
      }
      if (sortBy === 'lowestToHighest') {
        customers = yield sorts_1.sortByLowestNumber(
          customers,
          'total_order_amount'
        );
      }
      return yield search_1.default(
        customers,
        ['name', 'creation_date'],
        searchBy
      );
  ...
  customer(id) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return yield this.customersCollection.find(
...
__decorate(
  [
    ...
    __param(
      0,
      type_graphql_1.Arg('searchBy', (type) => String, { nullable: true })
    ),
    __param(
      1,
      type_graphql_1.Arg('sortBy', (type) => String, { defaultValue: null })
    ),
    __param(
      2,
...
CustomerResolver = __decorate([type_graphql_1.Resolver()], CustomerResolver);
