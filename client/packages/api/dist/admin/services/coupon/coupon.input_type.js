...
const product_input_type_1 = __importDefault(
  require('../product/product.input_type')
);
...
__decorate(
  [
    type_graphql_1.Field((type) => [product_input_type_1.default], {
      nullable: true,
    }),
...
__decorate(
  [type_graphql_1.Field({ nullable: true }), __metadata('design:type', Date)],
  AddCouponInput.prototype,
  'expiration_date',
  void 0
);
