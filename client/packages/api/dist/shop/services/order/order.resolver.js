...
__decorate(
  [
    type_graphql_1.Query(() => [order_type_1.default], {
      description: 'Get all the Orders',
    }),
    __param(
      0,
      type_graphql_1.Arg('user', (type) => type_graphql_1.Int)
    ),
    __param(
      1,
      type_graphql_1.Arg('text', (type) => String, { nullable: true })
    ),
    __param(
      2,
...
__decorate(
  [
    ...
    __param(
      0,
      type_graphql_1.Arg('id', (type) => type_graphql_1.Int)
    ),
    __metadata('design:type', Function),
...
__decorate(
  [
    type_graphql_1.Mutation(() => order_type_1.default, {
...
OrderResolver = __decorate([type_graphql_1.Resolver()], OrderResolver);
