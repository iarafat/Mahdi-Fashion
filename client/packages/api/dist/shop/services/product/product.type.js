...
const paginated_response_1 = __importDefault(
  require('../../helpers/paginated-response')
);
let Meta = class Meta {};
__decorate(
...
__decorate(
  [type_graphql_1.Field(() => [String]), __metadata('design:type', Array)],
  Meta.prototype,
  'languages',
  void 0
);
...
Meta = __decorate([type_graphql_1.ObjectType()], Meta);
exports.Meta = Meta;
...
Social = __decorate([type_graphql_1.ObjectType()], Social);
...
__decorate(
  [type_graphql_1.Field(() => [Social]), __metadata('design:type', Array)],
  Author.prototype,
  'socials',
  void 0
);
...
__decorate(
  [type_graphql_1.Field(), __metadata('design:type', Number)],
  Product.prototype,
  'id',
  void 0
);
...
__decorate(
  [type_graphql_1.Field(), __metadata('design:type', Date)],
  Product.prototype,
  'createdAt',
  void 0
);
Product = __decorate([type_graphql_1.ObjectType()], Product);
exports.default = Product;
let ProductResponse = class ProductResponse extends paginated_response_1.default(
  Product
) {
