...
let CouponResolver = class CouponResolver {
  ...
  applyCoupon(code) {
    return __awaiter(this, void 0, void 0, function* () {
      const coupon = yield this.items.find(
...
__decorate(
  [
    type_graphql_1.Query(() => [coupon_type_1.default], {
      description: 'Get all the Coupons',
    }),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', []),
    __metadata('design:returntype', Promise),
  ],
  CouponResolver.prototype,
  'coupons',
  null
);
__decorate(
...
CouponResolver = __decorate([type_graphql_1.Resolver()], CouponResolver);
