...
exports.vendorSamples = [
  ...
  createVendor({
    ...
    slug: 'red-dragon',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/red.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/mama.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'la-diplomate',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/la.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'joes-seafood',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/joes.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'cafe-chinese',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/cafe.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'bida manda',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/bida.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'fish-co',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/fish.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'bela-italia',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/bela.jpg',
    thumbnailUrl:
  ...
  createVendor({
    ...
    slug: 'thai-signature',
    previewUrl:
      'https://s3.amazonaws.com/redqteam.com/Mahdi Fashion/Food/thai.jpg',
    thumbnailUrl:
